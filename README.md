# ResoniteProtofluxFreezer
[![Build & Test (MonkeyLoader)](https://github.com/mpmxyz/ProtofluxFreezer/actions/workflows/build-monkey.yml/badge.svg?branch=main)](https://github.com/mpmxyz/ProtofluxFreezer/actions/workflows/build-monkey.yml)
[![Build & Test (ResoniteModLoader)](https://github.com/mpmxyz/ProtofluxFreezer/actions/workflows/build-rml.yml/badge.svg?branch=main)](https://github.com/mpmxyz/ProtofluxFreezer/actions/workflows/build-rml.yml)
...
3. After the action is finished, follow the instructions in the newly created Issue ```Setup repository to support full CI/CD```
   (most likely [#1](https://github.com/mpmxyz/ProtofluxFreezer/issues/1) when reading this in your repository)
...
- You can freely add dependencies to your project. Shared dependencies should be added to the project ProtofluxFreezer.csproj (without suffix!) to keep dependencies of the variants in sync.
...
- You can start Resonite directly from Visual Studio. The dll files/NuGet packages will be directly copied into the Resonite install.
  If you add additional files you have to adjust the scripts in the files ProtofluxFreezerMonkey.csproj and ProtofluxFreezerRML.csproj.
...
1. Increment the &lt;Version&gt; number within the files ```ProtofluxFreezer.csproj``` and ```Mod.RML/ProtofluxFreezerRML.cs```
2. Execute the github workflow ```Create Release```

## Installation (ResoniteModLoader)
1. Install [ResoniteModLoader](https://github.com/resonite-modding-group/ResoniteModLoader).
2. Download [release zip file](https://github.com/mpmxyz/ProtofluxFreezer/releases/latest/download/ProtofluxFreezer-ResoniteModLoader.zip) and extract contents into Resonite directory. (e.g. rml_mods should be merged with rml_mods.)
...
3. Add package "mpmxyz.ProtofluxFreezer.MonkeyLoader"
4. Start Resonite.
